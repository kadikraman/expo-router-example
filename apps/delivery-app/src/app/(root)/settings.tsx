...
const Settings = () => {
  const handleSettingPress = (action: string) => {
    switch (action) {
      case "personal-info":
        router.push("/(root)/settings/personal-info");
        break;
      case "notifications":
        router.push("/(root)/settings/notifications");
        break;
      case "payment":
        router.push("/(root)/settings/payment");
        break;
      case "help":
        router.push("/(root)/settings/help");
        break;
      case "contact":
        router.push("/(root)/settings/contact");
        break;
      default:
        console.log(`Settings action not yet implemented: ${action}`);
        // For unimplemented screens, show coming soon alert
        Alert.alert(
          "Coming Soon",
