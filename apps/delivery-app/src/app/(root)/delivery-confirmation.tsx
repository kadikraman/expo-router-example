...
const DeliveryConfirmation = () => {
    ...
    const handleConfirmBooking = async () => {
        ...
        setTimeout(() => {
            ...
            router.push(`/(root)/delivery-request?${new URLSearchParams(Object.fromEntries(Object.entries(params).map(([k, v]) => [k, String(v)]))).toString()}`);
        }, 2000);
    };
                ...
                <View className="px-5 py-6">
                    ...
                    <View className="bg-blue-50 rounded-xl p-5 mb-6">
                        ...
                        <View className="space-y-3">
                            ...
                            <View className="flex flex-row items-center">
                                <Text className="text-blue-600 mr-3 text-lg">✓</Text>
                                <Text className="text-blue-700">Photo confirmation of delivery</Text>
                            </View>
                            <View className="flex flex-row items-center">
                                <Text className="text-blue-600 mr-3 text-lg">✓</Text>
                                <Text className="text-blue-700">Direct communication with driver</Text>
                            </View>
                            <View className="flex flex-row items-center">
                                <Text className="text-blue-600 mr-3 text-lg">✓</Text>
                                <Text className="text-blue-700">Package protection up to $100</Text>
                            </View>
                        </View>
                    </View>
                    ...
                    <View className="mt-6 mb-10">
                        <Text className="text-xs text-gray-500 text-center leading-5">
                            ...
                            Your payment will be processed securely once the delivery is completed.
                        </Text>
                    </View>
                </View>
            </ScrollView>
