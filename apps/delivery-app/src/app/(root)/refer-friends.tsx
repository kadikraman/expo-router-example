...
const referralData = {
  ...
  pendingRewards: 25.0,
  totalEarned: 125.0,
  rewardPerReferral: 5.0,
  recentReferrals: [
    { name: "Sarah Smith", status: "completed", reward: 5.0, date: "Jan 15" },
    { name: "Mike Johnson", status: "pending", reward: 5.0, date: "Jan 12" },
    { name: "Emily Davis", status: "completed", reward: 5.0, date: "Jan 10" },
  ],
};
        ...
        <View className="mx-5 mt-5 p-5 bg-white rounded-xl shadow-sm shadow-neutral-300">
          ...
          <View className="flex flex-row items-start">
            ...
            <View className="flex-1">
              ...
              <Text className="text-gray-600 text-sm">
                Both of you get ${referralData.rewardPerReferral} after their
                first ride
              </Text>
            </View>
          </View>
